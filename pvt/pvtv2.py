...
class PyramidVisionTransformerV2(Backbone):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False, out_features=None):
        super().__init__()
        ...
        for i in range(num_stages):
            ...
            if stage in self._out_features:
                self._out_feature_strides[stage] = 4 if i == 0 else 2 ** (i + 2)
...
def build_pvtv2_backbone(cfg, input_shape):
    """
    ...
    return PyramidVisionTransformerV2(
        ...
        linear=cfg.MODEL.PVT.V2_LINEAR,
        out_features=out_features
    )


@BACKBONE_REGISTRY.register()
def build_pvtv2_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
    ...
    """
    bottom_up = build_pvtv2_backbone(cfg, input_shape)
